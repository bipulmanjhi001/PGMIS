...
public class GeneratePdfbrsReportActivity extends AppCompatActivity {
    ...
    private void init() {
        ...
        aAdapter = new PdfBrsReportAdapter(this, BrsReportActivity.pdfGenerateDataList);
    ...
    public void generatePDF(RecyclerView view,String fromdate,String todate) {
        ...
        if (adapter != null) {
            ...
            final File file = new File(dir, "pgmis_brs_report.pdf");
            ...
            runOnUiThread(new Runnable() {
                ...
                public void run() {
                    ...
                    AlertDialog.Builder builder = new AlertDialog.Builder(GeneratePdfbrsReportActivity.this);
                    builder.setTitle("Success")
                            ...
                            .setPositiveButton(android.R.string.ok, new DialogInterface.OnClickListener() {
                                public void onClick(DialogInterface dialog, int whichButton) {
                                    ...
                                    intent.setDataAndType( FileProvider.getUriForFile(GeneratePdfbrsReportActivity.this, BuildConfig.APPLICATION_ID + ".provider",file), "application/pdf");
