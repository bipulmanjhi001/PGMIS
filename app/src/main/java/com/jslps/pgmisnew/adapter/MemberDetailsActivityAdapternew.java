...
public class MemberDetailsActivityAdapternew extends RecyclerView.Adapter<MemberDetailsActivityAdapternew.MyViewHolder> {

    private List<Pgmemtbl> list;
    private List<Pgmemtbl> newItemList;
    private MDAPresenternew presenter;
    ...
    class MyViewHolder extends RecyclerView.ViewHolder  {
        ...
        Button cheque_click,iteam_click;
        ...
        MyViewHolder(View view) {
            ...
            iteam_click=view.findViewById(R.id.iteam_click);
            cheque_click=view.findViewById(R.id.cheque_click);
        }
    }

    public MemberDetailsActivityAdapternew(MDAPresenternew presenter, List<Pgmemtbl> itemList) {
    ...
    @NotNull
    @Override
    public MemberDetailsActivityAdapternew.MyViewHolder onCreateViewHolder(@NotNull ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.view_memberdetailsnew,
                parent, false);

        return new MemberDetailsActivityAdapternew.MyViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(@NotNull MemberDetailsActivityAdapternew.MyViewHolder holder, int position) {
