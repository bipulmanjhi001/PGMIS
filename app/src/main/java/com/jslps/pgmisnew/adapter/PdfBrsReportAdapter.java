...
public class PdfBrsReportAdapter extends RecyclerView.Adapter<PdfBrsReportAdapter.MyViewHolder> {
...
//        ConstraintLayout constraintLayout8;
    ...
    public PdfBrsReportAdapter(Context context, List<BrsReportModel> itemList) {
    ...
    public MyViewHolder onCreateViewHolder(@NotNull ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.pdf_brs_report, parent, false);
...
//        holder.textView79.setText(item.getPaymentmode());
        ...
        holder.headText.setText(item.getYear());
        holder.receivedAntText.setText(item.getBalanceCashbook());
