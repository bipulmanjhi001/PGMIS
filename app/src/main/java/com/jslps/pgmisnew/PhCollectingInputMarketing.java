...
public class PhCollectingInputMarketing extends AppCompatActivity implements
        PhCollectingInputView, PhCollectingInputInteractor.PhcollectingInputInteractor,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ph_collecting_input_marketing);
                ...
                try {
                    if (!type.equals("")) {
                        ...
                        PhCollectingInputnewtbl phCollectingInputnewtbl = new PhCollectingInputnewtbl(
                                phCollectingInputtbls.get(adapterPosition).getUuid(),
                                phCollectingInputtbls.get(adapterPosition).getPgcode(),
                                phCollectingInputtbls.get(adapterPosition).getGrpmemcode(),
                                phCollectingInputtbls.get(adapterPosition).getGrpcode(),
                                "",
                                payment_date.getText().toString(),
                                phCollectingInputSpinnerModels.get(adapterPosition).getType(),
                                "",
                                "",
                                "0",
                    ...
                    e.printStackTrace();
                    new StyleableToast
                            .Builder(PhCollectingInputMarketing.this)
    ...
    public void setOpenCalender() {
        ...
        DatePickerDialog dpd = DatePickerDialog.newInstance(
                PhCollectingInputMarketing.this,
    ...
    public void setViewAdapternew(ConstraintLayout firstLayout, ImageView edit,
        ...
        dropDown.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (mActive) {
                    Animation slideup = AnimationUtils.loadAnimation(PhCollectingInputMarketing.this, R.anim.slide_up);
                    ...
                    Animation slidedown = AnimationUtils.loadAnimation(PhCollectingInputMarketing.this, R.anim.slide_down);
        ...
        if(phCollectingInputSpinnerModels.size()>0){
            String type = phCollectingInputSpinnerModels.get(adapterPosition).getType();
            if(type!=null){
                if(type.equals("FPC")||type.equals("Others")){
                    if(type.equals("FPC")){
                        select_input_type.setSelection(1);
                    }else{
                        select_input_type.setSelection(2);
                    }
                }
            }else{
                select_input_type.setSelection(0);
            }
        }
    }
    ...
    public void onDateSet(DatePickerDialog view, int year, int monthOfYear, int dayOfMonth) {
        ...
        if (date1 != null && date1.compareTo(date2) > 0) {
            Toast.makeText(PhCollectingInputMarketing.this, "कृपया मान्य तिथि चुनें", Toast.LENGTH_LONG).show();
        }
        else {
