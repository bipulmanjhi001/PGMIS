...
public class BRSActivity extends AppCompatActivity implements DatePickerDialog.OnDateSetListener {
    ...
    private void calculateBankBalanceaspercashbook(String lastdateofprevious) {
        ...
        List<Itempurchasedbypgtbl> ItempurchasedbypgtblList = Select.from(Itempurchasedbypgtbl.class)
                .where(Condition.prop("pgcode").eq(PgActivity.pgCodeSelected))
                .where(Condition.prop("paymentmode").eq("Bank"))
              //  .where(Condition.prop("isexported").eq("1")) now it has commented need to confirmation
                    ...
                    if(calculateActualDifference()==0){
                        ...
                        if(imageFileName1.length() >5 && imageFileName2.length() >5) {
                            ...
                            if (imageFileName1.length() > 5) {
                                Pgmisbrsimgtbl pgmisbrsimgtbl = new Pgmisbrsimgtbl(imageFileName1, "0", PgActivity.pgCodeSelected);
                                pgmisbrsimgtbl.save();
                            }

                            if (imageFileName2.length() > 5) {
                                Pgmisbrsimgtbl pgmisbrsimgtbl = new Pgmisbrsimgtbl(imageFileName2, "0", PgActivity.pgCodeSelected);
                                pgmisbrsimgtbl.save();
                            }
    ...
    private void saveinlesstbl(String uuid) {
        ...
        if (!editText9.getText().toString().equals("")) {
            ...
            Pgmisbrstransaddsubtbl data = new Pgmisbrstransaddsubtbl(uuid,"7","LESS",amount1+"",new GetCurrentDate().getDate(),"0",PgActivity.pgCodeSelected);
            data.save();
        }

        if (!editText10.getText().toString().equals("")) {
            amount2 = Double.parseDouble(editText10.getText().toString());
            Pgmisbrstransaddsubtbl data = new Pgmisbrstransaddsubtbl(uuid,"8","LESS",amount2+"",new GetCurrentDate().getDate(),"0",PgActivity.pgCodeSelected);
            data.save();
        }

        if (!editText11.getText().toString().equals("")) {
            amount3 = Double.parseDouble(editText11.getText().toString());
            Pgmisbrstransaddsubtbl data = new Pgmisbrstransaddsubtbl(uuid,"9","LESS",amount3+"",new GetCurrentDate().getDate(),"0",PgActivity.pgCodeSelected);
            data.save();
        }

        if (!editText12.getText().toString().equals("")) {
            amount4 = Double.parseDouble(editText12.getText().toString());
            Pgmisbrstransaddsubtbl data = new Pgmisbrstransaddsubtbl(uuid,"10","LESS",amount4+"",new GetCurrentDate().getDate(),"0",PgActivity.pgCodeSelected);
            data.save();
        }

        if (!editText13.getText().toString().equals("")) {
            amount5 = Double.parseDouble(editText13.getText().toString());
            Pgmisbrstransaddsubtbl data = new Pgmisbrstransaddsubtbl(uuid,"11","LESS",amount5+"",new GetCurrentDate().getDate(),"0",PgActivity.pgCodeSelected);
            data.save();
        }
    }
    ...
    private void saveinadtbl(String uuid) {
        ...
        if (!editText3.getText().toString().equals("")) {
            ...
            Pgmisbrstransaddsubtbl data = new Pgmisbrstransaddsubtbl(uuid,"1","ADD",amount1+"",new GetCurrentDate().getDate(),"0",PgActivity.pgCodeSelected);
            data.save();
        }

        if (!editText4.getText().toString().equals("")) {
            amount2 = Double.parseDouble(editText4.getText().toString());
            Pgmisbrstransaddsubtbl data = new Pgmisbrstransaddsubtbl(uuid,"2","ADD",amount2+"",new GetCurrentDate().getDate(),"0",PgActivity.pgCodeSelected);
            data.save();
        }

        if (!editText5.getText().toString().equals("")) {
            amount3 = Double.parseDouble(editText5.getText().toString());
            Pgmisbrstransaddsubtbl data = new Pgmisbrstransaddsubtbl(uuid,"3","ADD",amount3+"",new GetCurrentDate().getDate(),"0",PgActivity.pgCodeSelected);
            data.save();
        }

        if (!editText6.getText().toString().equals("")) {
            amount4 = Double.parseDouble(editText6.getText().toString());
            Pgmisbrstransaddsubtbl data = new Pgmisbrstransaddsubtbl(uuid,"4","ADD",amount4+"",new GetCurrentDate().getDate(),"0",PgActivity.pgCodeSelected);
            data.save();
        }

        if (!editText7.getText().toString().equals("")) {
            amount5 = Double.parseDouble(editText7.getText().toString());
            Pgmisbrstransaddsubtbl data = new Pgmisbrstransaddsubtbl(uuid,"5","ADD",amount5+"",new GetCurrentDate().getDate(),"0",PgActivity.pgCodeSelected);
            data.save();
        }

        if (!editText8.getText().toString().equals("")) {
            amount6 = Double.parseDouble(editText8.getText().toString());
            Pgmisbrstransaddsubtbl data = new Pgmisbrstransaddsubtbl(uuid,"6","ADD",amount6+"",new GetCurrentDate().getDate(),"0",PgActivity.pgCodeSelected);
            data.save();
        }
    }
    ...
    private double calculateActualDifference() {
        double diff =100;//making sure it is not zero without calculation
