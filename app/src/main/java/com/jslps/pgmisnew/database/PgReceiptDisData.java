...
public class PgReceiptDisData extends SugarRecord {
    ...
    public PgReceiptDisData(String budgethead, String budgetcode, String accountno, String ekoshamount, String pgcode, String approveddate, String budgetid, String BMID) {
