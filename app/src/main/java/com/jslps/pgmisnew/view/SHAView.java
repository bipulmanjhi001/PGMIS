...
public interface SHAView {
    ...
    void setViewAdapter(ConstraintLayout firstLayout, TextView farmer,
                        ...
                        int adapterPosition, CheckBox checkBox, TextView pos,
                        TextView payment_date,
                        String payment_type, RadioGroup radioGroup,
                        ImageView call_calender);

    void setRecyclerView();

    void addTextChangeListner(ConstraintLayout firstLayout,
                              TextView farmer, TextView total,
                              TextView paid, TextView remaining,
                              TextInputEditText enterAmount, View viewLayout,
                              int adapterPosition, CheckBox checkBox,
                              TextView pos,TextView payment_date,
                              String payment_type);
